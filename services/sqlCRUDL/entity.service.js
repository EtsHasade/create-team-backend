...
const teamOptions = {
    ...
    this.createFields: ['name', 'description', 'projectId', 'creatorId'],
    this.updateFields: ['name', 'description', 'projectId'],
    this.txtFields: ['name', 'description'],  
    this.getOutputEntity: _convertToJsTeam  
}
...
module.exports = class EntityCRUDService {
    ...
    getById = async (entityId) => {
        ...
        try {
            const [entity] = await DBService.runSQL(sql)
